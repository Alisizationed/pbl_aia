...
def line_is_valid(line):
    """ Analize whether the line is valid or not"""
    if line['frecventa_min'] <= 0 or line['durata_calatorie_min'] <= 0:
        return False
...
def station_is_valid(station):
    """ Analize whether the station is valid or not """
    # Verify if the coords are numeric
