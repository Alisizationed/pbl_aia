...
export default function OptimizePage() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/network/graph`)
      ...
      .catch(() => { if (!ignore) setGraphStatus('error') })
          ...
          <div className="opt-section">
            ...
            <div className="node-pills-row">
              <div
                ...
                onClick={() => { setStartNode(null); setEndNode(null); setPickMode('start') }}
              >
              ...
              <div
                ...
                onClick={() => { setEndNode(null); setPickMode('end') }}
              >
            ...
            {resultEntries.map(([trainId, routes]) => (
              <div key={trainId} className="train-block">
                <div className="train-block-header">
                  ...
                  <span className="badge badge-blue">{routes.length} route{routes.length !== 1 ? 's' : ''}</span>
                </div>
                {routes.length === 0 ? (
